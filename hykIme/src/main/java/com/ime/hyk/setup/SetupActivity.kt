...
import com.ime.hyk.R
import com.ime.hyk.databinding.ActivitySetupBinding
import com.ime.hyk.setup.SetupPage.Companion.firstUndonePage
import com.ime.hyk.setup.SetupPage.Companion.isLastPage
    ...
    override fun onPause() {
        if (SetupPage.hasUndonePage()) {
            NotificationUtils.notify(NOTIFY_ID) { param ->
                param
                    .setSmallIcon(R.mipmap.ic_hyk_ime)
